...
export function AccountingWorkPage() {
  ...
  return <div className="flex-1 min-h-0 bg-background flex flex-col">
    ...
    <div className="flex-1 min-h-0 grid grid-cols-[18rem_minmax(0,1fr)]">
      ...
      <main className="overflow-auto p-5 max-w-5xl w-full">{!loading && !cases.length && <BankCaseWorkflowControls detail={null} onChanged={load} />}{detail ? <div className="space-y-4">
        ...
        <BankCaseWorkflowControls detail={detail} onChanged={load} />
