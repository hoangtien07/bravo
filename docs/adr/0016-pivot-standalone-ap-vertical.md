...
- **Trạng thái:** **Accepted** (2026-07-05) — chủ dự án duyệt + Hội đồng thông qua. Trước đó Proposed (2026-06-26).
- **Ngày:** 2026-06-26 (đề xuất) · 2026-07-05 (Accepted)
- **Người đề xuất:** Rà soát phản biện (đối chiếu code thật + 5 repo tham chiếu trong workspace, đặc biệt **agent-ai/Atlas Builder**).
- **Căn cứ Accepted:** [COUNCIL-REVIEW-2026-07.md](../COUNCIL-REVIEW-2026-07.md) — Hội đồng end-user (kế toán trưởng · helpdesk · IT manager · CFO) bỏ phiếu **ỦNG HỘ 4/4**.
...
- **draft_queue Phase 3** (push ERP) **xoá khỏi roadmap** (xem ràng buộc Accepted) — không còn là lời hứa treo trong code.

**Điều kiện Accepted (2026-07-05) — Hội đồng chốt kèm ràng buộc:**
1. ✅ Chủ dự án xác nhận đổi định vị mũi nhọn (Finance "AI OS" → "Copilot AP độc lập trên TT99").
2. ✅ Hội đồng thông qua ([COUNCIL-REVIEW-2026-07.md](../COUNCIL-REVIEW-2026-07.md), 4/4 end-user ủng hộ).
3. ⏳ ≥3 phỏng vấn kế toán/CFO xác nhận pain-point AP đáng trả tiền — **tiến hành song song**, không chặn code (điều kiện gia hạn cho hợp đồng dài hạn, không chặn pilot).

**Ràng buộc bắt buộc kèm Accepted (Hội đồng yêu cầu — nếu thiếu thì pivot chỉ là vòng đứt khoác tên mới):**
- **Trang hàng đợi duyệt nháp tập trung** (lọc trạng thái, duyệt lô, tổng Nợ/Có) — Wave 1.
- **Nút xuất Excel/CSV ngay trong luồng duyệt**, đúng format nhập BRAVO, có cột `source_ref` truy nguồn hoá đơn gốc — Wave 1 (backend `journal_export.py` + `routes_drafts.py` đã sẵn).
- **Dán nhãn "DEMO — dữ liệu mock"** trên mọi màn chạy mock (Anomaly/Tax/Knowledge Graph) — Wave 0. Tuyệt đối không trộn số mock với số thật không nhãn.
- **Xuất-file-để-nhập-tay là TÍNH NĂNG KIỂM SOÁT, không phải nợ kỹ thuật.** Con người là cổng ghi cuối (kế toán trưởng yêu cầu rõ điểm này).

**Danh sách ĐÓNG BĂNG 🧊** (giữ nguyên trạng, không mở rộng/không sửa ngoài crash, tới L3 + ≥1 khách thật): Anomaly agent · Tax agent · Knowledge Graph · AR-collections · IFRS · money-engine ngoài AP.

**Xoá khỏi roadmap** (không "hoãn"): push draft → ERP staging (cũ là Phase 3). Export file là đầu ra chính thức; ERP API chỉ là nâng cấp tùy chọn Phase sau, **không gating**.
