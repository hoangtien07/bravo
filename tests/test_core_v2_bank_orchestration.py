...
from app.core_v2.case_state import RevisionConflict
...
def test_http_routes_enforce_server_identity_scope_and_complete_headlessly():
    ...
    identity = Identity(employee_id=uuid.uuid4(), department_ids=[uuid.uuid4()],
                        permissions=frozenset({"accounting_case:create"}))
